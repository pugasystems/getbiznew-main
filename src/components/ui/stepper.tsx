...
import { LoaderCircleSvg } from '@/assets/icons/Svgs';
    ...
    variants: {
      variant: {
        circle: cn(
          ...
          "[&:not(:last-child)]:after:w-[2px] [&:not(:last-child)]:after:bg-grey200 [&:not(:last-child)]:after:content-['']",
      ...
      >
        ...
        >
          ...
          <StepLabel
            ...
            {...{ isCurrentStep, isCompletedStep, opacity }}
          />
        </div>
        <div
          className={cn(
    ...
    return (
      <div
        ...
        className={cn(
          ...
          '[&:not(:last-child)]:after:transition-all [&:not(:last-child)]:after:duration-200',
          "[&:not(:last-child)]:after:h-[2px] [&:not(:last-child)]:after:bg-grey200 [&:not(:last-child)]:after:content-['']",
          'data-[completed=true]:[&:not(:last-child)]:after:bg-primary',
          'data-[invalid=true]:[&:not(:last-child)]:after:bg-danger',
          variant === 'circle-alt' &&
  ...
  return (
    <Button
      ...
      className={cn(
        ...
        'data-[active=true]:border-primary data-[active=true]:bg-primary data-[active=true]:text-inverted',
        'data-[current=true]:border-primary data-[current=true]:bg-primary data-[current=true]:text-inverted',
        'data-[invalid=true]:border-danger data-[invalid=true]:bg-danger data-[invalid=true]:text-inverted',
    ...
    return React.useMemo(() => {
      if (isCompletedStep) {
        if (isError && isKeepError) {
          return (
            <div key="icon">
              <Cross1Icon className={cn(iconVariants({ size }))} />
            </div>
          );
        }
        return (
      ...
      {!!label && (
        <span
          className={cn(
            ...
            labelVariants({ size }),
            styles?.['step-label'],
            isCurrentStep || isCompletedStep ? 'text-primary' : 'text-muted',
          )}
        >
          {label}
        </span>
